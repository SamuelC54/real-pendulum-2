"""HTTP API for the live MuJoCo plant (used by physical-motor-service and control-api)."""
...
def main() -> None:
    ...
    print(f"[simulation] MuJoCo plant at http://{args.host}:{args.port}", flush=True)
    try:
