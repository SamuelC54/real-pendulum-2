...
export type GetStatusReply = Message<"sensor.v1.GetStatusReply"> & {
   ...
   *
   * @generated from field: bool limit_left_pressed = 6;
   */
  limitLeftPressed: boolean;

  /**
   * @generated from field: bool limit_right_pressed = 7;
   */
